    ...
    render: function() {
        return (
            <div className="metaContainer">
                ...
                <TimesheetMeta className="timesheetMeta" ref="metaEdit" userID={this.props.timesheet.userID} timesheet={this.props.timesheet} hidden={this.state.edit} mobile={true} disabled={this.props.disabled}/>
            </div>
        );
    }
});
