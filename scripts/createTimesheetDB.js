...
try {
    client.query(
       "CREATE TABLE IF NOT EXISTS Timesheets ( index serial PRIMARY KEY, timesheet_foreignkey varchar(36), service_description TEXT, service_duration REAL, service_date DATE, delete BOOLEAN)"
    );
    client.query(
