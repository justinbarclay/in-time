...
function createUserDB() {
    ...
    try {
        client.query(
            "CREATE TABLE IF NOT EXISTS UserLogin ( user_id serial PRIMARY KEY, username varchar(32) UNIQUE,  password varchar(64), email varchar(32) UNIQUE, role varchar(32), invited, invited_on timestamptz,last_accessed timestamptz )"
        );
    } catch (error) {
        console.log(error);
    }
