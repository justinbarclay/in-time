...
function createUserDB() {
    ...
    try {
        client.query(
            "CREATE TABLE IF NOT EXISTS Users ( user_id serial PRIMARY KEY, email varchar(32) UNIQUE, password varchar(64), role TEXT, invite_code varchar(36), invited_on timestamptz, supervisor varchar(32), org_foreignkey INTEGER, last_accessed timestamptz )"
        );
    } catch (error) {
        console.log(error);
    }
